...
--actor-width 1024 --q-width 1024 --crate-step-size 0.3 --q-crate-step-size 0.2 &> outputs/sac_crate/humanoid-walk/run13_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 22     --env-id dm_control/humanoid-walk-v0 --total-timesteps 4000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.3 --q-crate-step-size 0.2 &> outputs/sac_crate/humanoid-walk/run14_0.5.out
