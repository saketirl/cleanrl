...
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run9_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 18     --env-id dm_control/acrobot-swingup-v0 --total-timesteps 1000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run10_0.5.out
python cleanrl/sac_crate_normed.py     --seed 19     --env-id dm_control/acrobot-swingup-v0 --total-timesteps 1000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run11_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 20     --env-id dm_control/acrobot-swingup-v0 --total-timesteps 1000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run12_0.5.out
python cleanrl/sac_crate_normed.py     --seed 21     --env-id dm_control/acrobot-swingup-v0 --total-timesteps 1000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run13_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 22     --env-id dm_control/acrobot-swingup-v0 --total-timesteps 1000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run14_0.5.out
python cleanrl/sac_crate_normed.py     --seed 23     --env-id dm_control/acrobot-swingup-v0 --total-timesteps 1000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run15_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 24     --env-id dm_control/acrobot-swingup-v0 --total-timesteps 1000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.8 --q-crate-step-size 0.6 &> outputs/sac_crate/acrobot-swingup/run16_0.5.out
