...
python cleanrl/sac_crate_normed.py     --seed 23     --env-id dm_control/dog-run-v0 --total-timesteps 4000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 &> outputs/sac_crate/dog-run/run15_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 24     --env-id dm_control/dog-run-v0 --total-timesteps 4000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 &> outputs/sac_crate/dog-run/run16_0.5.out
python cleanrl/sac_crate_normed.py     --seed 25    --env-id dm_control/dog-run-v0 --total-timesteps 4000000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 &> outputs/sac_crate/dog-run/run9_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 26     --env-id dm_control/dog-run-v0 --total-timesteps 4000000 --track \
