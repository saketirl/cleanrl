...
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run9_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 18     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run10_0.5.out
python cleanrl/sac_crate_normed.py     --seed 19     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run11_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 20     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run12_0.5.out
python cleanrl/sac_crate_normed.py     --seed 21     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run13_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 22     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run14_0.5.out
python cleanrl/sac_crate_normed.py     --seed 23     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run15_0.5.out &
python cleanrl/sac_crate_normed.py     --seed 24     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --q-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.4 --ckpt-n-step 20000  \
--ckpt-dir data/crate_ckpt/ant/ &> outputs/sac_crate/ant/run16_0.5.out
