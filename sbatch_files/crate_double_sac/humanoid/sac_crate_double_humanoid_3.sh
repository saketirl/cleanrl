...
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run9_0.5.out &
python cleanrl/sac_crate_double_continuous.py     --seed 18     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run10_0.5.out
python cleanrl/sac_crate_double_continuous.py     --seed 19     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run11_0.5.out &
python cleanrl/sac_crate_double_continuous.py     --seed 20     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run12_0.5.out
python cleanrl/sac_crate_double_continuous.py     --seed 21     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run13_0.5.out &
python cleanrl/sac_crate_double_continuous.py     --seed 22     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run14_0.5.out
python cleanrl/sac_crate_double_continuous.py     --seed 23     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run15_0.5.out &
python cleanrl/sac_crate_double_continuous.py     --seed 24     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.5 --q-crate-step-size 0.3 &> outputs/sac_crate/humanoid/run16_0.5.out
