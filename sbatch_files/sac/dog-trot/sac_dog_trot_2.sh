...
python cleanrl/sac_continuous_action.py     --seed 22     --env-id dm_control/dog-trot-v0 --total-timesteps 4000000 --track --actor-width 1024 --q-width 1024 &> outputs/sac/dog-trot/run14.out
python cleanrl/sac_continuous_action.py     --seed 23     --env-id dm_control/dog-trot-v0 --total-timesteps 4000000 --track --actor-width 1024 --q-width 1024 &> outputs/sac/dog-trot/run15.out &
python cleanrl/sac_continuous_action.py     --seed 24     --env-id dm_control/dog-trot-v0 --total-timesteps 4000000 --track --actor-width 1024 --q-width 1024 &> outputs/sac/dog-trot/run16.out
sleep 1800