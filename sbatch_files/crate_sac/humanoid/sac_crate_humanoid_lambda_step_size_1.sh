...
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run9_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 10     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run10_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 11     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run11_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 12     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run12_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 13     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run13_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 14     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run14_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 15     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run15_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 16     --env-id Humanoid-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/humanoid/run16_0.4.out
