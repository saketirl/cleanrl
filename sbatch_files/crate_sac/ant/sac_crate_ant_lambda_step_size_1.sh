...
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run1_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 2     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run2_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 3     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run3_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 4     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run4_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 5     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run5_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 6     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run6_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 7     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run7_0.4.out
python cleanrl/sac_crate_continuous.py     --seed 8     --env-id Ant-v4 --total-timesteps 500000 --track \
--actor-width 1024 --crate-step-size 0.4 --lambd 0.2 &> outputs/sac_crate/ant/run8_0.4.out
