...
#python cleanrl/sample_data_one_layer_gelu.py --policy-dir-path data/ckpt/cheetah-one-layer/ --total-timesteps 1000 --env-id HalfCheetah-v4  --actor-width 65536 --states-output-path data/states_rollouts/cheetah-one-layer/